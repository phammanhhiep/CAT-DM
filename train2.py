...
class CUDACallback(Callback):
    ...
    def on_train_epoch_end(self, trainer, pl_module, outputs):
        ...
        max_memory = torch.cuda.max_memory_allocated(current_device) / 2 ** 20
...
if __name__ == "__main__":
    ...
    # Set trainer_kwargs
    # =============================================================
    final_trainer_args = OmegaConf.to_container(trainer_config, resolve=True) # Convert OmegaConf to dict    
    final_trainer_args['max_epochs'] = 200
    final_trainer_args['accelerator'] = "gpu" 
    final_trainer_args['num_nodes'] = 1
    ...
    default_logger_cfg = {
        "target": "pytorch_lightning.loggers.TensorBoardLogger", # <--- CHANGE HERE
        "params": {
            "save_dir": logdir, # Keep saving in the specific experiment logdir
            "name": "",         # Setting name="" usually logs directly into save_dir/version_X
                                # Alternatively, use name="tensorboard_logs" to get logdir/tensorboard_logs/version_X
            "version": ""       # Let the logger handle versioning (e.g., version_0, version_1)
        }
    }
    ...
    default_callbacks_cfg = {
        ...
        "image_logger": {
            ...
            "params": {"batch_frequency": 500, "log_steps": [1]}
        },
    ...
    final_trainer_args.update(trainer_kwargs)

    # =============================================================
    # Initialize trainer with trainer_kwargs 
    # =============================================================
    trainer = Trainer(**final_trainer_args)
